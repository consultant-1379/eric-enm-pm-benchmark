...
{{- define "eric-enm-pm-bench.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-enm-pm-bench.mergeAnnotations" -}}
  {{- include "eric-enm-pm-bench.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-enm-pm-bench.mergeLabels" -}}
  {{- include "eric-enm-pm-bench.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
